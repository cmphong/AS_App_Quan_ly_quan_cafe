...
public class AdapterCategory extends RecyclerView.Adapter<AdapterCategory.CategoryViewHolder> {
    ...
    public interface IOnCategeroyItem {
        ...
        void onLongClickItemListener(Category category);
    }
    ...
    public AdapterCategory(Context context, IOnCategeroyItem iOnCategeroyItem){
    ...
    public void onBindViewHolder(@NonNull @NotNull CategoryViewHolder holder, int position) {
        ...
        holder.item_category.setOnLongClickListener(new View.OnLongClickListener() {
            @Override
            public boolean onLongClick(View v) {
                iOnCategeroyItem.onLongClickItemListener(categoryCurrent);
                return false;
            }
        });
    }
        ...
        public CategoryViewHolder(@NonNull @NotNull View v) {
            ...
            v.setOnCreateContextMenuListener(new View.OnCreateContextMenuListener() {
                ...
                public void onCreateContextMenu(ContextMenu menu, View v, ContextMenu.ContextMenuInfo menuInfo) {
                    menu.add(0, 11, 0, context.getString(R.string.Edit));
                    menu.add(0, 12, 0, context.getString(R.string.Delete));
                }
            });
        }
    }
